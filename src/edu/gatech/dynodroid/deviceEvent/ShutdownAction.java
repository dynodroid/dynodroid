...
public class ShutdownAction extends BroadCastAction implements IDeviceAction {
	
	public ShutdownAction(String completeComponentName,ArrayList<String> intFilter) throws Exception{
	...
	public BroadCastAction getInstance(String completeComponentName,ArrayList<String> intFilter) throws Exception {
		return new ShutdownAction(completeComponentName, intFilter);
	}
