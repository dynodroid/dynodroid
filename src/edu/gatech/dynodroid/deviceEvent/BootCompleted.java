...
public class BootCompleted extends BroadCastAction implements IDeviceAction {
	
	
	
	public BootCompleted(String completeComponentName,ArrayList<String> intFilter) throws Exception{
		if(completeComponentName != null){
			...
			throw new Exception("Problem occured while creating BootCompleted Action receiver");
		}
	}
	
	@Override
	public BroadCastAction getInstance(String completeComponentName,ArrayList<String> intFilter) throws Exception {
		return new BootCompleted(completeComponentName, intFilter);
	}
